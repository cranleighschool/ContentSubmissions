...
return [
	...
	'limitation_filter' => env('ADLDAP_LIMITATION_FILTER', '(|(memberof=CN=AllTeachingStaff,OU=Groups,DC=cranleigh,DC=org)(memberof=CN=AllBursarialStaff,OU=Groups,DC=cranleigh,DC=org)(memberof=CN=Sec_Staff,OU=Groups,OU=Prep School Users,DC=cranleigh,DC=org))'),
